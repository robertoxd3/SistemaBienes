...
private final Activo act = new Activo();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GraficosController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GraficosController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {  
        ...
        out.println(gson.toJson(daoA.getActivosGrafico()));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println(gson.toJson(daoA.getActivosGraficoPastel()));
    } catch (SQLException ex) {
        Logger.getLogger(GraficosController.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
